 ...
 * screen.
 */
public class PushPuzzle implements CommandListener {
    Display display;
...
display=kavax.microedition.lcdui.MIDtxt.dp;
   ...
   //display=kavax.microedition.lcdui.MIDtxt.mk.getDisplay(this);
        score = new Score();
    ...
    public void commandAction(Command c, Displayable s) {
        ...
        display.setCurrent(kavax.microedition.lcdui.MIDtxt.lastD1);
            //destroyApp(false);
         //   notifyDestroyed();
